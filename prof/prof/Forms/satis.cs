...
namespace prof.Forms
{
    public partial class satis : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            bagla.Open();
            SqlCommand komut2 = new SqlCommand("Insert into rapor (alisfiyat,masraflar,satisfiyat,netkar,tarih,numara) values (@alisfiyat,@masraflar,@satisfiyat,@netkar,@tarih,@numara)", bagla);
            ...
            komut2.Parameters.AddWithValue("@numara", textBox1.Text);
